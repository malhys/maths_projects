...
\begin{mybilan}
	...
	\begin{itemize}
		...
		\item $f(A \cup B)$ est la \kw{fréquence de la réunion} de $A$ et $B$ :
		
		\begin{eqnarray*}
			f(A \cup B) &=& \dfrac{Effectif\; de\; A + Effectif\; de\; B }{Effectif\; de\; E}
		\end{eqnarray*}
	
		\item $f(A \cap B)$ est la \kw{fréquence conjointe} de $A$ et $B$ :
		
		\begin{eqnarray*}
			f(A \cap B) &=& \dfrac{Effectif\; du\; croisement \; de\;A\; et\; de\; B }{Effectif\; de\; E}
		\end{eqnarray*}
	
		\item $f_B(A)$ est la \kw{fréquence conditionnelle} de $A$ \kw{sachant} $B$ :
