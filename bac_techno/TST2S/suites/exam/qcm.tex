\section{Questions à choix multiple}
...
\begin{questions}
	...
	\question[1] La feuille de calcul ci-dessous est utilisée pour calculer les premiers termes de la suite géométrique $(u_n)$ de premier terme \num{5000} et de raison \num{1.02}. La formule à entrer dans la cellule B3 et à recopier vers le bas est :
	...
	\begin{center}
		\includegraphics[scale=0.75]{qcm}
	\end{center}
