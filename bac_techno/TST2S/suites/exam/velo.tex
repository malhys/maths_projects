...
\begin{questions}
	\question Programme d'entrainement d'Aline
		...
		On note $u_n$ la distance parcourue la n-ième semaine. Ainsi $u_1 = 20$ et $u_{15}=118$.
		\begin{parts}
			...
			\begin{solution}
				\begin{eqnarray*}
					S_{15} &=& \dfrac{15 \times (u_1 + u_15)}{2} \\
					S_{15} &=& \dfrac{15 \times (20 + 118)}{2} \\
					S_{15} &=& \num{1035}
				\end{eqnarray*}
		...
		On note $v_n$ la distance parcourue la n-ième semaine. Ainsi $v_1 = 20$ et $v_{15}=118$.
		\begin{parts}
			...
			\begin{solution}
				\begin{eqnarray*}
					S_{15} &=&  u_1 \times \dfrac{1 - \num{1.135}^15}{1-\num{1.135}} \\
					S_{15} &=& 20 \times \dfrac{1 - \num{1.135}^15}{1-\num{1.135}} \\
					S_{15} &\approx& \num{841.82}
				\end{eqnarray*}
