...
\begin{questions}
	...
	\end{multicols}
	\vspace*{-0.5cm}				
	Les probabilités conditionnelles des événements $P_A(B)$ et $P_B(\bar{A})$ valent respectivement \num{0.29} et \num{0.43}.	
...
\begin{questions}
	...
	\begin{parts}
		\part 
		\begin{eqnarray*}
			P(E) &=& \frac{Nb \; de \; 85-95 ans}{Total} \\
			P(E) &=& \frac{2299}{5900} \\
			P(E) &=& \num{0.39}
		\end{eqnarray*}
	
		\begin{eqnarray*}
			P(F) &=& \frac{Nb \; de \; personnes\; à\; domicile}{Total} \\
			P(F) &=& \frac{3776}{5900} \\
			P(F) &=& \num{0.64}
		\end{eqnarray*}
	\end{parts}
