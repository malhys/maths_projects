\section{Moyennes trimestrielles}
...
\begin{questions}
	\question Représenter le diagramme en boite correspondant.
	
	\question Parmi les informations suivantes, lesquelles sont vraies, fausses ou indécidables (Indécidable signifie que l'on ne peut pas conclure avec les éléments connus). Justifier votre réponse dans chacun des cas.
	
	\begin{parts}
		\part 50\% des élèves de la classe Rouge ont une note comprise entre 10 et 12.
		\part 75\% des élèves de la classe Rouge ont une note inférieure ou égale à 12.
		\part Au moins 50\% des élèves de la classe Rouge ont une note inférieure ou égale à la note médiane de la série Jaune.
	\end{parts}
\end{questions}