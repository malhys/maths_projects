...
\begin{frame}
	\begin{mydefs}
		\begin{itemize}
			...
			\item Tous les points situés à la même distance d'un point $O$, forment un \kword{cercle de centre O}. \pause Cette distance est le \kword{rayon} du cercle. \pause
			\item Tous les points situés à une distance inférieure ou égale à $r$ d'un point $O$, \pause forment le \kword{disque de centre O} et de rayon $r$.
		\end{itemize}
	\end{mydefs}
\end{frame}
