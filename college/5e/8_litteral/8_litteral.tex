...
\chap[num=8, color=red]{Expressions littérales}{}
...
\begin{mydef}
	Une \kw{expression littérale} est une expression numérique qui \kw{contient une où plusieurs lettres}. Ces lettres désignent des nombres, ce sont des \kw{inconnues}.
\end{mydef}
