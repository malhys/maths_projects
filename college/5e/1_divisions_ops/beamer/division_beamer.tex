...
\begin{frame}
	\begin{myprop}
		Dans une expression numérique sans parenthèse, on effectue les multiplications et les divisions \kword{avant} les additions et les soustractions.\pause
	\end{myprop}
...
\begin{frame}
	\begin{myprop}
		Dans une expression numérique qui contient des parenthèses, on effectue 	\kword{d'abord les calculs entre parenthèses}. \pause
	\end{myprop}
