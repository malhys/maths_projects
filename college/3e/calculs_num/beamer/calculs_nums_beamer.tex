...
\begin{frame}
	...
	\begin{itemize}
		\item<alert@2> Cellule humaine : \onslide<2->{$\num{1e-5}$ m}\onslide<15->{ \textcolor{red}{ (7)}}
		\item<alert@3> Salmonelle : \onslide<3->{$\num{3e-6}$ m}\onslide<12->{ \textcolor{red}{ (4)}}
		\item<alert@4> Fièvre jaune : \onslide<4->{$\num{2e-8}$ m}\onslide<9->{ \textcolor{red}{ (1)}}
		\item<alert@5> Tétanos : \onslide<5->{$\num{4e-6}$ m}\onslide<13->{ \textcolor{red}{ (5)}}
		\item<alert@6> Staphylocoque : \onslide<6->{$\num{1e-6}$ m}\onslide<11->{ \textcolor{red}{ (3)}}
		\item<alert@7> Globule rouge : \onslide<7->{$\num{7.5e-6}$ m}\onslide<14->{ \textcolor{red}{ (6)}}
		\item<alert@8> Grippe : \onslide<8->{$\num{1.2e-7}$ m}\onslide<10->{  \textcolor{red}{ (2)}}
	\end{itemize}
